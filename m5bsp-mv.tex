...
%
% Um eigenes Figuren auszufertigen, empfiehlt es sich daher,
...
%
% Vorteile der Ausarbeitung einer Figurenblatts mit diesem Projekt gegenüber
% der reinen PDF- oder Papierversion sind:
%
% 1. Daten müssen nur einmalig für alle Figurenblätter eingegeben werden.
...
%    Falls sich Basiswerte ändern (z.B. durch Verbesserungswürde), kann man
%    nur den geänderten Wert neu setzen ohne alle anderen zu wiederholen.
...
% "a "o "ü  "A "O "U "s (Paragraph und Euro werden wohl nicht benötigt).
...
{ % Alle Daten innerhalb der Klammern werden nach dme Schließen vergessen.
% Dies kann man benutzen, um z.B. mehrere Figuren zu erstellen.
% Hätten wir den Spieler ebenfalls in die Klammer gesetzt, würde dieser
...
\DefData{Datum01}{{01.01.14}{4800}{300}{1748}}
...
% er muss eindeutig sein. Falls Name leer ist, kann nicht referenziert werden;
% dies ist z.B. bei leeren Einträgen sinnvoll.
% Falls [Name] weggelassen wird, wird Fähigkeit als Name benutzt.
% (Dies kann bei komplizierten Fähigkeiten - mit Umlauten, newlines usw. -
% zu TeX-Fehlern führen; daher [Name] im Zweifelsfall nicht weglassen).
% Bonus ist der Bonus, auf den die Fertigkeit gelernt ist
% PP sie ev. noch ausstehende Praxispunkte.
...
\Fertigkeit1{Pflanzenkunde}[10][5]
\Fertigkeit1[Fuardayn]{Landeskunde Fuardayn}[10][5]% Referenzname: Fuardayn
\Fertigkeit1{Tierkunde}[9][2]
\Fertigkeit1{Zauberkunde}[8][6]
...
\Fertigkeit1[]{}
\Fertigkeit1{Seilkunst}[12][1]
\Fertigkeit1{Schleichen}[8][4]
\Fertigkeit1{Bootfahren}[10]
\Fertigkeit1{Schwimmen}[16][1]
\Fertigkeit1{Klettern}[14][1]
\Fertigkeit1[]{}
\Fertigkeit1[]{}
\Fertigkeit1[Wurf daneben]{Wurf daneben (PW-25:Zt/2;
...
% \Fertigkeit referenziert. Für die korrekte Referenzierung ist es nicht
% nötig, das Figurenblatt später auch tatsächlich auszugeben. Zudem ist
% es nicht nötig, dass das entsprechende \Fertigkeit-Aufruf vor der
% Referenzierung im File steht. Es m muss allerdings vor der Ausgabe
% des Abenteuerblatts erscheinen.
...
% genommen.
% Die "Fähigkeit" Raufen kann auch im nichtgesetzten Fall referenziert werden.
...
% Die "Waffe" Raufen kann auch im nichtgesetzten Fall referenziert werden.

\Waffe1[Wasserklinge]{1Schwert}[2]{AB}[1W6+5]
\Waffe1[Langschwert]{1Schwert}{AB}[1W6+4]
\Waffe1[Keule]{1Schlag}{AB}[1W6+2]
\Waffe1[Dolch]{Stich}{AB}[1W6+2]
...
\Zauber2{Wasserstrahl (W.-Llinge)}{1 (+1)}{Erschaffen}%
...
% Wird vor das folgende \end{document} ein Kommentarzeichen % geschrieben,
% so wird anschließend die nächste Figur ausgeben;
% ansonsten beendet \end{document} das Dokument, und der Rest wird ignoriert.
\end{document}
